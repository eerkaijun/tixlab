...
const createFormState = (
  ...
  if (!hasAgreedTOS) {
    return _createFormState(
      true,
      null // "You need to agree with terms of service in order to submit the form"
    );
  }
            ...
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-1 relative rounded-md">
                ...
                <p className="text-xs text-gray-700">
                  ...
                  is lower the order can be declined
                </p> */}
              </div>
              ...
              <div className="text-xs text-gray-700 flex mt-5">
                ...
                <span>
                  I accept Tixlab &apos;terms of service&apos; and I agree that
